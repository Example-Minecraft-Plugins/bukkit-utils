...
public class InteractiveInventory {
    public static ItemStack createToggleItem(boolean config, HashMap<String, String> nbtTags, String name, String description) {
    ...
    public static ItemStack createActionItem(ItemStack item, HashMap<String, String> nbtTags, String name, List<String> lore) {
